...
const updateInventoryAmount = async(transaccion, turno, branchDb) => {

    try {
        if (!branchDb) throw new Error('Se requiere contexto de base de datos sucursal');
...
const revertInventoryAmount = async(transaccion, turno, branchDb) => {
